...
void setup()
{
    ...
    Serial.print("Receiver Start, version:");
    Serial.println(RECEIVER_VERSION);
...
void RxData_RF(void) 
{
    ...
    if(No_of_Bytes == PacketLength)
    {
        ...
        {
            data = ReadReg(CC2500_RXFIFO);
            Serial.println(data,HEX);
        }
    } else {
        Serial.print("Error!!! PacketLength should be: ");
